...
if __name__ == '__main__':
    ...
    destination_directory = os.path.realpath(sys.argv[2])
    destination_file = os.sep.join([destination_directory, 'index.html'])
    ...
    print('  input file: {}'.format(report_file))
    print('  output dir: {}'.format(destination_directory))
